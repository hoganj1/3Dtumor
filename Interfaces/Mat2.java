...
public interface Mat2 {
     ...
     */
    default int SQsToLocalIs(int[] SQs, int[] ret, int centerX, int centerY, boolean wrapX, boolean wrapY){
    ...
    default int SQsToLocalIs(int[] SQs, int[] ret, int centerX, int centerY){
        //moves coordinates to be around origin
        //if any of the coordinates are outside the bounds, they will not be added
        int ptCt=0;
        for(int i=0;i<SQs.length/2;i++) {
