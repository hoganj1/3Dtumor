 ...
 */
public class StringParam extends JTextField implements Misc.MenuItem,GuiComp {
    String labelText;
    public JLabel label;
    int compX;
    int compY;
    ...
    /**
     * @param mySet the ParamSet that can be queried to get the value of this menuString
     * @param label the label of the menuString
     * @param initVal the starting value of the menuString
     */
    public StringParam(ParamSet mySet, String label, String initVal){
        super(10);
        nCols=10;
        this.compX=1;
        this.compY=2;
     ...
     */
    public StringParam(ParamSet mySet, String label, String initVal, int nCols, int compX, int compY){
        super(nCols);
        this.nCols=nCols;
        this.compX=compX;
        this.compY=compY;
