 ...
 */
public class ComboBoxParam extends JComboBox implements Misc.MenuItem,GuiComp {
    String labelText;
    JLabel label;
    int compX;
    int compY;
     ...
     */
    public ComboBoxParam(ParamSet mySet, String label, int initVal, String[] options){
        super(options);
     ...
     */
    public ComboBoxParam(ParamSet mySet, String label, int initVal, String[] options, int compX, int compY){
        super(options);
        this.labelText=label;
        this.label=new JLabel(labelText);
        this.compX=compX;
    ...
    /**
     * sets the foreground and background of the ComboBoxParam
     ...
     */
    public ComboBoxParam SetColor(Color foregroundColor, Color backgroundColor){
